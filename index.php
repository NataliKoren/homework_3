...
$job = [
'job_name' => ['Порт Амстердам', 'Порт Одесса', 'Порт Ростов на Дону'],
'job_data' => ['2019-настоящее время', '2000-2004', '2005-2015'],
'job_desc' => ['Судовые грузоперевозки', 'Судовые грузоперевозки', 'Судовые грузоперевозки']
]
?>
